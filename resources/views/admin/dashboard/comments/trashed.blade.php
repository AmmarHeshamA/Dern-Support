...
@section('content')
    ...
    <div class="d-flex justify-content-center my-5">
        <a href="{{ route('admin.comment.index') }}" class="btn btn-primary mx-4 btn-lg my-5">Back</a>
    </div>
    <!-- all categoryes -->
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                                ...
                                <tr class="text-center mx-auto">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <form action="{{ route('admin.comment.restore', $comment->id) }}"
                                            ...
                                            <form action="{{ route('admin.comment.forceDelete', $comment->id) }}"
                ...
                @else
                    <h1 class="text-center">No Trashed Comments</h1>
                @endif
